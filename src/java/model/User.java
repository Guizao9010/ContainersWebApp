...
public class User {
    ...
    public static ArrayList<User> getUsers() throws Exception{
        ...
        ResultSet rs = s.executeQuery("SELECT rowid, * from users");
        while(rs.next()){
    ...
    public static User getUser(String login, String password) throws Exception{
        ...
        s.setString(1, login);
        s.setString(2, AppListener.getMd5Hash(password));
    ...
    public static void insertUser(String login, String name, String role, String password) throws Exception{
        ...
        s.setString(2, name);
        s.setString(3, role);
        s.setString(4, AppListener.getMd5Hash(password));
        s.execute();
        s.close();
        con.close();
    }
    ...
    public static void updateUser(String login, String name, String role, String password) throws Exception{
        ...
        s.setString(1, name);
        s.setString(2, role);
        s.setString(3, AppListener.getMd5Hash(password));
        s.setString(4, login);
        s.execute();
        s.close();
        con.close();
    ...
    public static void changePassword(String login, String password) throws Exception{
        ...
        PreparedStatement s = con.prepareStatement(sql);
        s.setString(1, AppListener.getMd5Hash(password));
        s.setString(2, login);
        s.execute();
        s.close();
        con.close();
